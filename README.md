...
> The fun, daily drawing challenge bot for Discord! Compete to draw the most perfect circle and climb the leaderboard. 🏆

A Discord bot that analyses circle drawings and maintains daily leaderboards. Users can submit circle drawings, get their circularity scores, and compete on daily leaderboards.

## ✨ Features

- **🎨 Circle Analysis**: Analyses uploaded images to determine circularity percentage
...
- **⚙️ Easy Configuration**: Simple `!set` command for channel setup
...
### 6. Configure the Challenge Channel
...
3. **Get Score**: Bot analyses the image and returns a circularity percentage
